                ...
                <tbody  id="myTable" >
                   ...
                   $r = $conn->query($query1);
                    ...
                    <tr>
                            ...
                            <td class="border-2 px-3 w-72 "><a href="bloodBankBookGenConfigBlood.php?ID=<?php echo $_GET['ID'] ?>&BG=<?php echo $Brow["BloodGroup"]?>&stock=<?php echo $Brow['SUM(AddStock)']?> " class="font-semibold text-lg text-gray-700 capitalize font-poppins tracking-wide">বুকিং<br>
