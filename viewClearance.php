...
<link rel="icon" href="Images and logo/logo4.png">
  ...
  <body>
    ...
    <div>
      ...
      $sql="SELECT * FROM hospitalbloodbank WHERE BloodID = '$BloodID'  ";
      $query=mysqli_query($conn,$sql);

      while ($info=mysqli_fetch_array($query)) {
        ?>
      <embed type="application/pdf" src="folder2/<?php echo $info['Clearance'] ; ?>" width="1920" height="1080">
    <?php
