            ...
            <div class="w-auto ml-10 p-5">
                <div class="grid pt-20">
                    <div class="grid shadow-2xl w-fit px-4 py-4 rounded-xl ">
                        <p class="text-slate-700">ALL REPORT LIST</p>
                ...
                <thead >
                <tr >
                    <th class="border-2 px-3">Paitent ID</th>
                    <th class="border-2 px-3">Paitent Email</th>
                    <th class="border-2 px-3">Report</th>
                ...
                <tbody  id="myTable" >
                   ...
                   $query1 = "SELECT * FROM hospitalpatientreport WHERE HosID = '$HOSPid' ";
                   $r = $conn->query($query1);
                    ...
                    while($Brow = $r->fetch_assoc()){
                        ?>
                    <tr>
                            <td class="border-2 px-16"><?php echo $Brow["PatientID"]?> </td>
                            <td class="border-2 px-16"><?php echo $Brow["Email"]?> </td>
                            <td class="border-2 px-16"><?php echo $Brow["ReportPDF"]?> </td>
           
                            <td class="border-2 px-16 "><a href="hospitalReportDownload.php?PatientID=<?php echo $Brow['PatientID']?>" target="blank">View or Download</td>
