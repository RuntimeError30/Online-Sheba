            ...
            <div class="w-auto ml-10 ">
                <div class="grid pt-20">
                    <div class="grid shadow-2xl w-fit px-4 py-4 rounded-xl bg-[conic-gradient(at_left,_var(--tw-gradient-stops))] from-gray-100 to-gray-300">
                        <p class="text-slate-800">DOCTORS LIST</p>
                ...
                <div class="flex">
                    <div class="text-black mt-16 font-semibold shadow-xl px-4 py-4 w-fit rounded-xl">
                        <h1 class="text-2xl text-slate-500 ">ALL ACTIVE AND OFFLINE DOCTORS LIST</h1>
                ...
                <thead >
                <tr >
                    <th class="border-2 px-3">Photo</th>
                    <th class="border-2 px-3">Name</th>
                    <th class="border-2 px-3">Doctor ID</th>
                    <th class="border-2 px-3 ">Sector</th>
                    <th class="border-2 px-3 ">Active Status</th>
                ...
                <tbody  id="myTable" >
                   ...
                   $query1 = "SELECT * FROM hospitaldoctors WHERE HospitalID = '$HOSPid'";
                   $r = $conn->query($query1);
                    ...
                    while($Brow = $r->fetch_assoc()){
                        ?>
                    <tr>
                            <td class="border-2 px-3 w-44"><img class="w-40 h-56 px-4 py-4" src='folder2/<?php echo $Brow["ProfilePhoto"]; ?>' alt="" srcset=""> </td>
                            <td class="border-2 px-3 w-44"><?php echo $Brow["Name"]?> </td>
                            <td class="border-2 px-3 w-44"><?php echo $Brow['ID']?> </td>
                            <td class="border-2 px-3 w-44"><?php echo $Brow['Sector']?> </td>
                            <td class="border-2 px-3 w-44"><?php echo $Brow['ActiveStatus']?> </td>
           
                            <td class="border-2 px-3 w-72 "> 

                    
                               <a href="HospitalseeDocPatient.php?DocID=<?php echo $Brow['ID']?>">Paitent of <?php echo $Brow["Name"]?></a></td>
