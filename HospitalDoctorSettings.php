...
if(isset($_POST["Change"])){
    ...
    if($row["Password"]==$OldPass){
        if($ReTypeNewPass==$NewPass){
            $query = "UPDATE hospitaldoctors SET Password = '$NewPass' WHERE ID = '$ID'";
            mysqli_query($conn,$query);

            echo "Successfully Password Changed";
        }
        else{
            echo "Password did not matched with new password";
        }
    }
    else{
            ...
            <div class="w-auto ml-10 ">
                <div class="grid pt-20">
                    <div class="grid shadow-2xl w-fit px-4 py-4 rounded-xl bg-[conic-gradient(at_left,_var(--tw-gradient-stops))] from-gray-100 to-gray-300">
                        <p class="text-slate-800">DOCTORS PROFILE - SETTINGS</p>
                ...
                <div class="flex">
                    ...
                    <div class="p-5 rounded-xl shadow-2xl ">
                    <h1 class="text-xl text-slate-500 ">CHANGE PASSWORD</h1>
                        <form action="" method="POST">

                            <input type="password" style="font-family: 'CharukolaUltraLight', sans-serif;" class="border-2 w-96 pl-4 border-slate-900 rounded-lg py-2 hover:scale-110 hover:border-[#c04848] ease-out duration-700" name="OldPass" id="" placeholder="Old Password"><br><br><br>

                            <input type="password" style="font-family: 'CharukolaUltraLight', sans-serif;" class="border-2 w-96 pl-4 border-slate-900 rounded-lg py-2 hover:scale-110 hover:border-[#c04848] ease-out duration-700" name="NewPass" id="" placeholder="New Password"><br><br><br>

                            <input type="password" style="font-family: 'CharukolaUltraLight', sans-serif;" class="border-2 w-96 pl-4 border-slate-900 rounded-lg py-2 hover:scale-110 hover:border-[#c04848] ease-out duration-700" name="ReTypeNewPass" id="" placeholder="Re-Type New Password"><br><br><br>

                            <input type="submit" id="submit" name="Change" value="Change Password" style="font-family: 'CharukolaUltraLight', sans-serif;" class="px-28  bg-gradient-to-l from-[#c04848] to-[#480048] drop-shadow-2xl text-white font-extrabold py-4 border-none hover:rounded-2xl hover:shadow-2xl hover:cursor-pointer hover:scale-110 hover:bg-gradient-to-r from-[#480048] to-[#c04848] transition-all ease-out duration-700"><br>
                        </form>
                        </form>
                    </div>
