    ...
    <section class="flex-col py-36"  style="background-image: url('folder2/bgPng1.png');">
        ...
        <div class="grid justify-start mx-20 ">
            ...
            <div class="grid font-sem text-xl mt-7 " style="font-family: 'CharukolaUltraLight', sans-serif;">
                ...
                <a href="BloodDonnerRegistration.php" class="hover:bg-red-600 w-full hover:text-white delay-100 ease-in transition-all">ব্লাড ডোনার রেজিস্ট্রেশন/লগ-ইন  </a><br>
                ...
                <a href="FirstLanding.php" class="hover:bg-red-600 w-full hover:text-white delay-100 ease-in transition-all">পূর্বরর্তী পেইজে যান</a>
            </div>
