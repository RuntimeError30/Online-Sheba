...
<body class="bg-gray-100 text-white">
    <main>
        ...
        <div class="flex flex-wrap">
            <div class="w-3/12 bg-gray-300 rounded p-3 shadow-lg">
            ...
            <div class="w-auto ml-10 p-5">
                <div class="grid pt-20">
                    <div class="grid shadow-2xl w-fit px-4 py-4 rounded-xl ">
                        <p class="text-slate-700">NOTIFICATIONS</p>
                ...
                <?php
                   ...
                   $query1 = "SELECT * FROM hospitalnotification WHERE ID = '$HOSPid'";
                   $r = $conn->query($query1);

                   
                    while($Brow = $r->fetch_assoc()){
                        ?>
                    <h1><?php echo $Brow["Notification"]; ?></h1><hr><br><br>
                    <?php
                    }
                    ?>
