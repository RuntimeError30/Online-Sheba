    ...
    <main class="">
        <div class="grid justify-center ">
            <div class="shadow-2xl bg-gray-100 w-fit h-fit">
                ...
                <div id="sidebar" class="grid  justify-start absolute -left-3 top-72 bg-gradient-to-b from-[#2c2c2c] to-[#181818] w-fit h-fit p-5 rounded-r-xl scale-90">
                    <ul class="space-y-2 text-sm">
                        <a href="createaGeneralMemberAcc.php" class="font-semibold text-lg text-gray-700 capitalize font-poppins tracking-wide hover:text-white transition-all">
                    ...
                    <ul class="space-y-2 text-sm">
                        <a href="createaGeneralMemberAcc.php" class="font-semibold text-lg text-gray-700 capitalize font-poppins tracking-wide">
                    ...
                    <ul class="space-y-2 text-sm">
                        <a href="" class="font-semibold text-lg text-gray-700 capitalize font-poppins tracking-wide">
                    ...
                    <ul class="space-y-2 text-sm">
                        <a href="HospitalDocLogin.php?ID=<?php echo $row['ID']?>" class="font-semibold text-lg text-gray-700 capitalize font-poppins tracking-wide">
                           <span class="flex my-6" id="star">
    
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"  class="w-6 h-6 text-gray-500 ">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M11.48 3.499a.562.562 0 011.04 0l2.125 5.111a.563.563 0 00.475.345l5.518.442c.499.04.701.663.321.988l-4.204 3.602a.563.563 0 00-.182.557l1.285 5.385a.562.562 0 01-.84.61l-4.725-2.885a.563.563 0 00-.586 0L6.982 20.54a.562.562 0 01-.84-.61l1.285-5.386a.562.562 0 00-.182-.557l-4.204-3.602a.563.563 0 01.321-.988l5.518-.442a.563.563 0 00.475-.345L11.48 3.5z" />
                              </svg><span class="px-2 text-lg">ডাক্তার লগইন</span>
                ...
                <div id="coverPhoto" class="relative mt-32  px-10 ">
                    ...
                    <div class="flex">
                        ...
                        <div class="pl-5 mt-5">
                            ...
                            <p>Gulshan -1212, Dhaka, Bangladesh</p>
            ...
            <div  class="relative grid top-20 bg-gray-100 shadow-2xl  w-full h-fit p-3">
                <h1 class="font-semibold text-2xl">কমেন্টসমূহ </h1>
