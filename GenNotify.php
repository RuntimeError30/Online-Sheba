        ...
        <div class="flex flex-wrap bg-gray-100 w-full h-screen">
            ...
            <div class="w-auto ml-10">
                <div class="p-10 scale-125 text-gray-600 ml-16 top-20 relative">
                    <h1 class="text-2xl font-bold ">স্বাগতম <?php echo $row["Name"]; ?></h1>
                    <p class=" text-gray-500">আপনার নোটিফিকেশনসমূহ</p>
                </div>
                <div class="flex-col my-28  pl-28 tracking-wider">
                    <?php
                     ...
                     $query = "SELECT * FROM notifications WHERE Email = '$fetchMail'";
                     $result = $conn->query($query);
  
                     while($Notrow = $result->fetch_assoc()){  
                    ?>
                    <h1><?php echo $Notrow["Notifications"];?></h1><br><br><br>
                    <div class=""></div>
