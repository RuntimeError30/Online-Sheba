...
<body class="bg-gray-100" style="font-family: 'CharukolaUltraLight', sans-serif;">
    <nav class="bg-gradient-to-b from-[#480048] to-[#480048] text-white flex justify-evenly py-4 px-9 border-spacing-0 border-b-0 h-56">
        ...
        <a href="index.php"style="font-family: 'CharukolaUltraLight', sans-serif;" class="flex"><img src='folder2/<?php echo $Prow["ProfilePhoto"]; ?>' class=" relative w-20 h-20 py-1 border-2 -left-10 top-3 rounded-lg scale-50 "></a>
    </nav>
    <main class="">
        <div class="m-10">
                ...
                <tbody  id="myTable">
                   ...
                   $result = $conn->query($query1);
                    ...
                    <tr>
                            ...
                            <td class="border-2 px-3"><a href="DocAppointmentSet.php?ID=<?php echo $Drow['ID']?>&&HospitalID=<?php echo $Drow['HospitalID']?>" >অ্যাপয়েন্টমেন্ট দিন</a></td>
