...
if(isset($_POST["submit"]))
{
    ...
    $duplicate = mysqli_query($conn, "SELECT * FROM generalmemberlist WHERE UniqueID = ' $UniqueID' OR Email = '$Email'");
    ...
    if(mysqli_num_rows($duplicate)>0){
        ...
        if( $NewPassword == $ReNewPassword){
            $query = "INSERT INTO generalmemberlist VALUES('$Name', '$UniqueID' ,'$Email', 
           '$District', '$Division','$FullAddress','$Mobile','$EmergencyMobile','$NewPassword','$ReNewPassword','$ProfilePhoto')";
...
<body>
    ...
    <main class="scale-90">
        ...
        <section class="flex-col py-10"  style="background-image: url('folder2/bgPng1.png');">
            ...
            <div>
                <h1 class="font-bold text-5xl flex justify-center" style="font-family: 'Hind Siliguri', sans-serif;">সাইন-আপ</h1>
                <p class="font-semibold text-base py-3 flex justify-center" style="font-family: 'CharukolaUltraLight', sans-serif;">আমাদের ই-হসপিতাল ওয়েবসাইটের সদস্য হতে ফর্মটি পুরন করুন</p>
            </div>
            ...
            <div class="flex justify-center py-14">
                <form action="" method="post" autocomplete="off" class="flex-col">
                    ...
                    <input type="text" style="font-family: 'CharukolaUltraLight', sans-serif;" class="bg-transparent border-2 w-96 pl-4 border-slate-900 rounded-lg py-2 hover:scale-110 hover:border-[#c04848] ease-out duration-700" name="UniqueID" id="" placeholder="ইউনিক আইডি"><br><br>
                    ...
                    <input type="text" style="font-family: 'CharukolaUltraLight', sans-serif;" class="bg-transparent border-2 w-96 pl-4 border-slate-900 rounded-lg py-2 hover:scale-110 hover:border-[#c04848] ease-out duration-700" name="FullAddress" id="" placeholder="সম্পুর্ণ ঠিকানা"><br><br>
                    ...
                    <!-- <select name="work" style="font-family: 'CharukolaUltraLight', sans-serif;" class="bg-transparent border-2 w-96 pl-4 border-slate-900 rounded-lg py-2 hover:scale-110 hover:border-[#c04848] ease-out duration-700">
                        <option value="No-Value">সদস্যের পাশাপাশি যা করতে চাই</option>
                        <option value="Blood-Donation">ব্লাড ডোনার</option>
                        <option value="Ambulance-Service">অ্যাম্বুলেন্স সেবা</option>
                        <option value="Organ-Donation">মরোনোত্তর অঙ্গদান</option>
                      </select><br><br> -->

                    <input type="password" style="font-family: 'CharukolaUltraLight', sans-serif;" class="bg-transparent border-2 w-96 pl-4 border-slate-900 rounded-lg py-2 hover:scale-110 hover:border-[#c04848] ease-out duration-700" name="NewPassword" id="" placeholder="নতুন পাসওয়ার্ড"><br><br>
        ...
        <section class="-translate-y-20">
            <div class="flex justify-center text-sm hover:scale-110 ease-out duration-700" style="font-family: 'CharukolaUltraLight', sans-serif; display:flex">
                <p>ইতোমধ্যে একজন সদস্য? <a href="GeneralLoginSignup.php" class=" hover:text-red-600 duration-700">লগ-ইন করতে এখানে ক্লিক করুন</a></p>
            </div>
        </section>
    </main>
