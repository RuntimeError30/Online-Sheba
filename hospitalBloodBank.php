            ...
            <div class="w-auto ml-10 p-5">
                <div class="grid pt-20">
                    <div class="grid shadow-2xl w-fit px-4 py-4 rounded-xl ">
                        <p class="text-slate-700">BLOOD BANK</p>
                ...
                <div class="text-black mt-16 font-semibold shadow-xl px-4 py-4 w-fit rounded-xl">
                    ...
                    <form action="HospitalBloodBankConfig.php" method="POST" class="mt-10 font-poppins tracking-wide" enctype="multipart/form-data">
                        <select name="BloodGroup" style="font-family: 'CharukolaUltraLight', sans-serif;"  class="relative mr-7 h-11 -top-5  bg-transparent border-2 w-96 pl-4 border-slate-900 rounded-lg  hover:scale-110 hover:border-[#c04848] ease-out duration-700">
                            <option value="No-Value">Select Blood Group to Upload</option>
                        ...
                        <label class="text-slate-500">Stock Filling Date</label><br>
                        <input type="date" name="updateDate" id="" class="bg-transparent border-2 w-96 pl-4 border-slate-900 rounded-lg py-2 hover:scale-110 hover:border-[#c04848] ease-out duration-700"><br><br>
                        
                        <label class="text-slate-500">Upload Patient Health Clearance Report</label><br>
                        <input type="file" name="Clearance" id="" class="bg-transparent border-2 w-96 pl-4 border-slate-900 rounded-lg py-2 hover:scale-110 hover:border-[#c04848] ease-out duration-700" accept=".pdf" ><br><br>



                        <input type="submit" id="submit" name="upload" value="Update List" style="font-family: 'CharukolaUltraLight', sans-serif;" class="px-28  bg-gradient-to-l from-[#c04848] to-[#480048] drop-shadow-2xl text-white font-extrabold py-4 border-none hover:rounded-2xl hover:shadow-2xl hover:cursor-pointer hover:scale-110 hover:bg-gradient-to-r from-[#c04848] to-[#480048] transition-all ease-out duration-700"><br><br>
                        <a href="HospitalBloodbankList.php">Go to List</a>
                    </form>
