...
<body style="background-image: url('folder2/bgPng1.png');" class="bg-[#fffbff]">
    ...
    <nav class="bg-gradient-to-r from-[#870000] to-[#190A05] text-white flex justify-between py-4 px-9 border-spacing-0 border-b-0 h-56">
...
<tbody  id="myTable">
    <?php
    $conn = mysqli_connect("localhost", "root", "", "onlinesheba");

    $num = $row["DonnerID"];
   $query1 = "SELECT * FROM bloodeligibility  WHERE Eligibility LIKE '%পারবেন' AND  ID != '$num'";
   $result = $conn->query($query1);
    ...
    <tr>
            ...
            <td class="border-2 px-3"><a href="urgentMessage.php?ID=<?php echo $row['ID']?>" class="" target="blank">নোটিফিকেশন পাঁঠান</a></td>
