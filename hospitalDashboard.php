    ...
    <main>
        ...
        <div class="flex flex-wrap">
            ...
            <div class="w-auto ml-10 p-5">
                ...
                <div>
                    <div class="flex pt-20 justify-start  align-baseline">
                        <div class=" px-4 py-4 bg-gray-800 drop-shadow-xl shadow-slate-600 rounded-xl h-52 w-56">
                            <h1 class="text-2xl font-semibold uppercase">Active <br> doctors</h1><br>
                            <p  class="text-6xl text-red-600 font-semibold uppercase">10</p>
                            <p  class="text-xl text-slate-600 font-semibold uppercase">out of 40</p>
                        </div>
                        <div class="bg-gray-800 drop-shadow-xl shadow-slate-600 ml-10 px-4 py-4 rounded-xl h-52 w-56">
                            <h1 class="text-2xl font-semibold uppercase">Active <br> Nurses</h1><br>
                            <p  class="text-6xl font-semibold  text-red-600 uppercase">32</p>
                            <p  class="text-xl text-slate-600 font-semibold uppercase">out of 50</p>
                        </div>
                        <div class="bg-gray-800 drop-shadow-xl shadow-slate-600 ml-10 px-4 py-4 rounded-xl h-52 w-56">
                            <h1 class="text-2xl font-semibold uppercase">Total <br> Patient</h1><br>
                            <p  class="text-6xl font-semibold  text-red-600 uppercase">32</p>
                            <p  class="text-xl text-slate-600 font-semibold uppercase">out of 50</p>
                        </div>
                        <div class="bg-gray-800 drop-shadow-xl shadow-slate-600 ml-10 px-4 py-4 rounded-xl h-52 w-56">
                            <h1 class="text-2xl font-semibold uppercase">New<br> Patient</h1><br>
                            <p  class="text-6xl font-semibold  text-red-600 uppercase">32</p>
                            <p  class="text-xl text-slate-600 font-semibold uppercase">out of 50</p>
                        </div>
                        <div class="bg-gray-800 drop-shadow-xl shadow-slate-600 ml-10 px-4 py-4 rounded-xl h-52 w-56">
                            <h1 class="text-2xl font-semibold uppercase">Treated <br> Patient</h1><br>
                            <p  class="text-6xl font-semibold  text-red-600 uppercase">32</p>
                            <p  class="text-xl text-slate-600 font-semibold uppercase">out of 50</p>
                        </div>
                    ...
                    <div class="flex pt-20 justify-start align-baseline">
                        <div class="bg-gray-800 drop-shadow-xl shadow-slate-600 px-4 py-4  rounded-xl h-52 w-56">
                            <h1 class="text-2xl font-semibold uppercase">Cabin<br> Booked</h1><br>
                            <p  class="text-6xl text-red-600 font-semibold uppercase">10</p>
                            <p  class="text-xl text-slate-600 font-semibold uppercase">out of 40</p>
                        </div>
                        <div class="bg-gray-800 drop-shadow-xl shadow-slate-600 ml-10 px-4 py-4 rounded-xl h-52 w-56">
                            <h1 class="text-2xl font-semibold uppercase">ICU <br>Booked</h1><br>
                            <p  class="text-6xl font-semibold  text-red-600 uppercase">32</p>
                            <p  class="text-xl text-slate-600 font-semibold uppercase">out of 50</p>
                        </div>
                        <div class="bg-gray-800 drop-shadow-xl shadow-slate-600 ml-10 px-4 py-4 rounded-xl h-52 w-56">
                            <h1 class="text-2xl font-semibold uppercase">CCU <br>Booked</h1><br>
                            <p  class="text-6xl font-semibold  text-red-600 uppercase">32</p>
                            <p  class="text-xl text-slate-600 font-semibold uppercase">out of 50</p>
                        </div>
                        <div class="bg-gray-800 drop-shadow-xl shadow-slate-600 ml-10 px-4 py-4 rounded-xl h-52 w-56">
                            <h1 class="text-2xl font-semibold uppercase">Total<br> Earning</h1><br>
                            <p  class="text-6xl font-semibold  text-red-600 uppercase">32000</p>
                            <p  class="text-xl text-slate-600 font-semibold uppercase">$</p>
                        </div>
                        <div class="bg-gray-800 drop-shadow-xl shadow-slate-600 ml-10 px-4 py-4 rounded-xl h-52 w-56">
                            <h1 class="text-2xl font-semibold uppercase">Day <br> Earning</h1><br>
                            <p  class="text-6xl font-semibold  text-red-600 uppercase">4000</p>
                            <p  class="text-xl text-slate-600 font-semibold uppercase">$</p>
                        </div>
