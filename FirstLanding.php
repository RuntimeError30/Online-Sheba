...
<body class="edit">
    ...
    <main class="grid">
        ...
        <nav class="bg-gradient-to-b from-[#480048] to-[#480048] text-white flex justify-between py-4 px-9 border-spacing-0 border-b-0">
            ...
            <li><a href="hospitalList.php" class="hover:text-rose-600 hover:shadow-xl transition-colors">হাসপাতালের তালিকা</a></li>
            ...
            <!-- <a href="GeneralLoginSignup.php"style="font-family: 'CharukolaUltraLight', sans-serif;" class="flex"><img src='folder2/avatar.png' class=" relative w-20 h-20 py-1 border-2 -left-10 top-3 rounded-lg scale-50 "></a> -->
            <div class="p-10">

  <div class="dropdown inline-flex relative bottom-5">
    <button class=" text-gray-700 font-semibold  rounded inline-flex items-center">
      <span class="mr-1"><img src='folder2/avatar.png' class=" relative w-20 h-20 py-1 border-2  rounded-lg scale-50 "></span>
      
    </button>
    <ul class="dropdown-menu absolute hidden text-gray-700 pt-2 w-44">
      <li class=""><a class="rounded-t bg-gray-200 hover:bg-gray-400 py-2 px-4 block whitespace-no-wrap" href="hospitalLoginMain.php">Hospital Admin</a></li>
      <li class=""><a class="rounded-t bg-gray-200 hover:bg-gray-400 py-2 px-4 block whitespace-no-wrap" href="pharmacyAdminLogin.php">Pharmacy Admin</a></li>
      <li class=""><a class="bg-gray-200 hover:bg-gray-400 py-2 px-4 block whitespace-no-wrap" href="GeneralLoginSignup.php">Generel Members</a></li>
      <li class=""><a class="rounded-b bg-gray-200 hover:bg-gray-400 py-2 px-4 block whitespace-no-wrap" href="BloodDonnerRegistration.php">Blood Donners</a></li>
