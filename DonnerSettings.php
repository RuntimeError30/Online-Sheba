...
<body>
    ...
    <nav class="bg-gradient-to-r from-[#870000] to-[#190A05] text-white flex justify-between py-4 px-9 border-spacing-0 border-b-0">
        ...
        <li><a href="BloodDonnerSearch.php" class="hover:text-rose-600 hover:shadow-xl transition-colors">অনলাইন রক্তদাতার সন্ধান</a></li>
            ...
            <a href=""style="font-family: 'CharukolaUltraLight', sans-serif;" class="flex"><img src='folder2/<?php echo $row["ProfilePhoto"]; ?>' class=" relative w-20 h-20 py-1 border-2 -left-10 top-3 rounded-lg scale-50 "></a>
        </nav>
        <div class="flex flex-wrap bg-gray-100 w-full h-full">
            ...
            <div class="flex-col my-28 pl-28 tracking-wider">
                ...
                <form action="DonnerSettingsConfig.php" method="POST" enctype="multipart/form-data" class="flex-col -translate-x-1/3 -translate-y-32">
                    ...
                    <input type="text" style="font-family: 'CharukolaUltraLight', sans-serif;" class="bg-transparent border-2 w-96 pl-4 border-slate-900 rounded-lg py-2 hover:scale-110 hover:border-[#c04848] ease-out duration-700" name="DonnerID" id="" placeholder="<?php echo $row['DonnerID']; ?>" readonly><br><br>




                      <input type="text" style="font-family: 'CharukolaUltraLight', sans-serif;" class="bg-transparent border-2 w-96 pl-4 border-slate-900 rounded-lg py-2 hover:scale-110 hover:border-[#c04848] ease-out duration-700" name="DonnerAge" id="" placeholder="<?php echo $row['DonnerAge']; ?>"><br><br>
                    ...
                    <input type="text" style="font-family: 'CharukolaUltraLight', sans-serif;" class="bg-transparent border-2 w-96 pl-4 border-slate-900 rounded-lg py-2 hover:scale-110 hover:border-[#c04848] ease-out duration-700" name="DonnerNumber" id="" placeholder="<?php echo $row['DonnerNumber']; ?>"><br><br>
                    <input type="text" style="font-family: 'CharukolaUltraLight', sans-serif;" class="bg-transparent border-2 w-96 pl-4 border-slate-900 rounded-lg py-2 hover:scale-110 hover:border-[#c04848] ease-out duration-700" name="DonnerEmNumber" id="" placeholder="<?php echo $row['DonnerEmNumber']; ?>"><br><br>
