...
font-family: 'Raleway', sans-serif;" >
    ...
    <form action="PharmacyMedicineSearch.php" method="POST" class="flex">
        <div class="grid ">
            <div class="flex justify-between">
                <h1 class="flex justify-start text-5xl font-extrabold tracking-wide relative  text-transparent bg-clip-text bg-gradient-to-r from-gray-700 via-gray-900 to-black" style="font-family: 'Hind Siliguri', sans-serif;">ঔষধসমূহ</h1>
                    ...
                    <input type="text" style="font-family: 'CharukolaUltraLight', sans-serif;" class="bg-transparent border-2 w-96 h-10 mt-5 pl-4 border-slate-900 rounded-lg py-1 hover:scale-110 hover:border-[#c04848] ease-out duration-700" name="valueToSearch" id="" placeholder="ঔষধ খুঁজুন"><br><br>

                    <input type="submit" name="search" value="সার্চ" class="flex relative right-1/4 w-10 mx-5 justify-center shadow-xl py-2 mt-5 bg-yellow-400 hover:rounded-2xl transition-all"><br><br>
            ...
            <?php
                ...
                <div class="mx-12">
                    ...
                    <a href="PharmacyOrderDonner.php?ID=<?php echo $Frow['ID']?>" class="flex justify-center shadow-xl py-2 mt-5 bg-yellow-400 hover:rounded-2xl transition-all">অর্ডার করুন</a>
                    <a href="PharmacyCart.php?ID=<?php echo $Frow['ID']?>" class="flex justify-center shadow-xl py-2 mt-5 bg-yellow-400 hover:rounded-2xl transition-all" >কার্টে যোগ করুন</a>
