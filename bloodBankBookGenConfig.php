...
if(isset($_POST["submit"])){
    ...
    $var = $STOCKBlood - $Quantity;
    $updateQuery = "UPDATE hospitalbloodbank set AddStock = '$var' WHERE HosID = '$hosID' AND BloodGroup = '$BG";
...
<nav class="bg-gradient-to-b from-[#480048] to-[#480048] text-white flex justify-evenly py-4 px-9 border-spacing-0 border-b-0 h-56">
    ...
    <div>
           ...
           <form action="" method="post">
                ...
                <input type="text" style="font-family: 'CharukolaUltraLight', sans-serif;" class="border-2 w-96 pl-4 border-slate-900 rounded-lg py-2 hover:scale-110 hover:border-[#c04848] ease-out duration-700" name="Mobile" id="" value="<?php echo $Prow["Mobile"]?>" placeholder="<?php echo $Prow["Mobile"] ?>" ><br><br><br>
                ...
                <input type="text" style="font-family: 'CharukolaUltraLight', sans-serif;" class="border-2 w-96 pl-4 border-slate-900 rounded-lg py-2 hover:scale-110 hover:border-[#c04848] ease-out duration-700" name="FullAddress" id="" value="<?php echo $Prow["FullAddress"]?>" placeholder="<?php echo $Prow["FullAddress"] ?>" ><br><br><br>
                <input type="text" style="font-family: 'CharukolaUltraLight', sans-serif;" class="border-2 w-96 pl-4 border-slate-900 rounded-lg py-2 hover:scale-110 hover:border-[#c04848] ease-out duration-700" name="BG" id="" value="<?php echo $_GET['BG']?>" placeholder="<?php echo $_GET['BG'] ?>" ><br><br><br>
