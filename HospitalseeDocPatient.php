...
if(!empty($_SESSION["Email"])){
  ...
  $query1F = mysqli_fetch_assoc(mysqli_query($conn,"SELECT * FROM hospitaldoctors WHERE HospitalID = '$HOSPid' AND ID = '$docID'"));
}
else{
...
<body class="bg-gray-100 ">
    <main>
        ...
        <div class="flex flex-wrap">
            <div class="w-3/12 bg-[conic-gradient(at_top_right,_var(--tw-gradient-stops))] from-gray-900 via-gray-100 to-gray-900 rounded p-3 shadow-lg w-fit h-screen  ">
            ...
            <div class="w-auto ml-10 ">
                <div class="grid pt-20">
                    <div class="grid shadow-2xl w-fit px-4 py-4 rounded-xl bg-[conic-gradient(at_left,_var(--tw-gradient-stops))] from-gray-100 to-gray-300">
                        <p class="text-slate-800">DOCTORS LIST - PATIENTS</p>
                ...
                <div class="flex">
                    <div class="text-black mt-16 font-semibold shadow-xl px-4 py-4 w-fit rounded-xl">
                        <h1 class="text-2xl text-slate-500 Uppercase">PATIENT LIST OF DR. <?php echo $query1F["Name"]?></h1>
                ...
                <tr >
                    ...
                    <th class="border-2 px-3">Patient Name</th>
                    <th class="border-2 px-3">Appointment ID</th>
                    <th class="border-2 px-3 ">Appointment Date</th>
                    <th class="border-2 px-3 ">Appointment Time</th>
                ...
                <tbody  id="myTable" >
                   ...
                   $query1 = "SELECT * FROM appointments WHERE HospitalID = '$HOSPid' AND DoctorID = '$docID'";
                   $r = $conn->query($query1);
                    ...
                    <tr>
                            ...
                            <td class="border-2 px-3 w-44"><?php echo $Brow["Name"]?> </td>
                            <td class="border-2 px-3 w-44"><?php echo $Brow['AppointmentID']?> </td>
                            <td class="border-2 px-3 w-44"><?php echo $Brow['Date']?> </td>
                            <td class="border-2 px-3 w-44"><?php echo $Brow['Time']?> </td>
                            <td class="border-2 px-3 w-44"><?php echo $Brow['Status']?> </td>
