<?php
    ...
    $result =  mysqli_query($conn, "SELECT * FROM hospitaldetails WHERE Email = '$Email' OR ID = '$Email'");
    ...
    <main>
        ...
        <section class="-translate-y-48">
            ...
            <div class="flex justify-center text-sm hover:scale-110 ease-out duration-700" style="font-family: 'CharukolaUltraLight', sans-serif;">
                <p>নতুন সদস্য হতে ইচ্ছুক? <a href="hospitalLogin.php" class=" hover:text-red-600 duration-700">এখানে ক্লিক করুন</a></p>
            </div>
        </section>
    </main>
</body>
