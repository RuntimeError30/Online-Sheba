    ...
    <div class="flex flex-wrap bg-gray-50 w-full h-full">
            ...
            <div class="w-auto">
                ...
                <div class="grid my-28  pl-28 tracking-wider">
                    ...
                    <form action="DonnerSeecurityConfig.php" method="post"  class="grid relative -left-9">
                    ...
                    <p style="font-family: 'CharukolaUltraLight', sans-serif;" class="relative -left-9">পাসওয়ার্ড ভুলে গিয়েছেন? <a href="DonnerPassReset.php?Email=<?php echo $row['Email']?>" class="hover:scale-110 " target="_blank">পাসওয়ার্ড রিকোভার করুন</a></p>
